...
@section('content')
    <div class="d-flex justify-content-start align-items-center m-3">
        <a href="{{ route('education.edit',['id'=>$education->id]) }}" class="text-secondary mr-2">
                ...
                <div>
                    @empty($question)
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="answerOptions" id="option1" value="0"
                                   checked>
                            <input type="text" name="options[]" placeholder="Write option answer"
